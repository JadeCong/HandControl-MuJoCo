...
parser.add_argument('--model-path', type=str, default='../model/learned/teachnet-zenmme_60.model', help='learned model path')
...
def main():
    ...
    try:
        while True:
            ...
            #     com[2] = 200
            # crop the region of hand
            hd = HandDetector(depth_image, 400, 400)
            com = hd.get_target_com()
            depth_image = hd.crop_area_3d(com, size=(250, 250, 250), img_size=(100, 100))
            ...
            tele_mpl.tele_callback(depth_image)
            # time.sleep(0.5)
