from joint_position_calculator.get_angle_new import *
import numpy as np
...
def get_hand_joint_pose(hand_kps):
    ...
    # calc the first joint of thumb finger
    # finger_pnv_direction_ref_vector = vector1
    # finger_first_joint_ref_vector = vector2
    thumb_ref_plane_normal_vector = np.array([-0.70710678, -0.5, -0.5]) #based on the MPL initial pose plane normal

    # thumb_joint0 = get_finger_first_joint(ref_plane_normal_vector[0], finger_pnv_direction_ref_vector, finger_first_joint_ref_vector, thumb_ref_plane_normal_vector)
