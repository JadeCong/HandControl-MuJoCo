from joint_position_calculator.get_angle_new3 import *
import numpy as np
...
def get_hand_joint_pose(hand_kps):
    ...
    index_delta = calc_plane_plane_angle(index_ref_plane_normal_vector_proj, middle_ref_plane_normal_vector)
    middle_delta = 0.0
    ring_delta = calc_plane_plane_angle(ring_ref_plane_normal_vector_proj, middle_ref_plane_normal_vector)
    pinky_delta = calc_plane_plane_angle(pinky_ref_plane_normal_vector_proj, middle_ref_plane_normal_vector)

    index_joint0 = index_joint0 - index_delta
    middle_joint0 = middle_joint0 + middle_delta
    ring_joint0 = ring_joint0 + ring_delta
    pinky_joint0 = pinky_joint0 + pinky_delta
