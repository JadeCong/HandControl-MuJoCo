...
from data_importer.data.transformations import rotatePoint2D, rotatePoints2D, rotatePoints3D
...
class HandDetector(object):
    ...
    def cropArea3D(self, com=None, size=(250, 250, 250), dsize=(128, 128), docom=False):
        ...
        hb = (yend - ystart)
        if wb > hb:
            sz = (dsize[0], int(round(hb * dsize[0] / wb)))
        else:
            sz = (int(round(wb * dsize[1] / hb)), dsize[1])
