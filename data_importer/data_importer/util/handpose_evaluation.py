...
import scipy
import cv2
from data_importer.data.importers import DepthImporter, NYUImporter, ICVLImporter, MSRA15Importer
from data_importer.util.helpers import rgb_to_gray
...
class HandposeEvaluation(object):
    ...
    def vtkPlotHand(self, renderer, joint3D, colors=(1, 0, 0)):
        ...
        if joint3D.shape[0] >= numpy.max(self.jointConnections):
            print('joint3d shape is lager')
            print(len(self.jointConnections))
